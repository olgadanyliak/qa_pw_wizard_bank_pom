...
test('Assert manager can choose currencies for account', async ({ page }) => {
  ...
  */
  ...
  await openAccountPage.assertCurrencyHasValue('Dollar');
  await openAccountPage.selectCurrency('Pound');
  await openAccountPage.assertCurrencyHasValue('Pound');
  await openAccountPage.selectCurrency('Rupee');
  await openAccountPage.assertCurrencyHasValue('Rupee');
});
